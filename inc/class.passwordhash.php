...
class PasswordHash {
    ...
    /**
     * Constructor for PasswordHash class
     * @param int $iteration_count_log2 Strength of salt (default: 8)
     * @param bool $portable_hashes If true, forces the use of weaker portable hashes (default: false)
     */
    ...
    private function crypt_private( $password, $setting ) {
        ...
        $app_id = substr( $setting, 0, 3 );
        # We use "$P$", phpBB3 uses "$H$" for the same thing
        if ( $app_id != '$P$' && $app_id != '$H$' )
            return $output;
    ...
    /**
     * Compares plain text password against stored password hash
     * @param string $password Plain text password
     * @param string $stored_hash Store password hash
     * @return bool Returns true if passwords are the same 
     */
